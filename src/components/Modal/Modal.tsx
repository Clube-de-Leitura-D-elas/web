 ...
 * Componente Modal.
 *
 * A implementar. Requisitos: card do Modal no Kanban + frame do componente no Figma.
 *
 ...
 *  - exporte como `export const Modal = ...` (nunca `export default`);
 *  - exporte também um `export type ModalProps = { ... }`;
